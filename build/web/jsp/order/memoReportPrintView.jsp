    ...
    <head>
        ...
        <script>
            ...
            function onPrintView() {
                var URL = "memoreport.do?method=printViewGS12";
                window.open(document.action = URL);
                document.forms[0].submit();
                var URL = "memoreport.do?method=loadGS12Transactions";
                document.forms[0].action = URL;
                document.forms[0].submit();
            }
        ...
        <html:form>
            <div class="container">
                ...
                <center style="float: right">
                    ...
                    <table id="example4" class="table table-condensed table-striped" border="1">
                        <thead>
                            <tr>
                                <th width="30%" style="vertical-align: middle">Workers Memo</th>
                                                    ...
                                                    <tbody>
                                                        <logic:iterate id="details1" name="details" property="lstDetails">
                                                            <tr>       
                                                                ...
                                                                <td width="12%"><bean:write name="details1" property="jewelDate" format="dd/MM/yyyy"/></td>
