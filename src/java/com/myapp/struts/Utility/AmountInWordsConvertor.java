 ...
 * @author Lenovo
 */
public class AmountInWordsConvertor {
    ...
    public String convertAmount(String strVal) {
...
//        }
        ...
        return processor.getName(strVal).toUpperCase();

    }

    public String convertAmount(double strVal) {
        processor = new DefaultProcessor();
...
//        }
    ...
    public String convertAmount(long strVal) {
        processor = new DefaultProcessor();
