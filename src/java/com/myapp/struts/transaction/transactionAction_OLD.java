...
// * @author Lenovo
// */
//public class transactionAction_OLD extends DispatchAction {
//    
...
//    TreeMap hmPayments = new TreeMap();
//    
...
//                transactionform.setMemberno(0);
//                
//                int memberno = Integer.parseInt(transactionform.getSelectedmember().split("-")[0]);
...
//
//                //           int termspaid = hmPayments.size();
////            if (!objMembers.getStatus().equalsIgnoreCase("settled")) {
////                if (group.getNoofinstallment() == termspaid) {
////                    transactionform.setStatus("Completed");
////                    transactionform.setTotalamount(transactionform.getTotalpaidamount() + transactionform.getDrawamount());
////                } else {
////                    transactionform.setStatus("In Progress");
////                    transactionform.setTotalamount(transactionform.getTotalpaidamount() + transactionform.getDrawamount());
////                }
////            } else {
////                transactionform.setStatus("Settled");
////                transactionform.setTotalamount(transactionform.getTotalpaidamount() + transactionform.getDrawamount());
////            }
...
//                        String PaymentDetails = payment.getPaymentid() + " - " + displaydate.format(payment.getPaiddate()) + " - " + (int) group.getInstallmentamount() + " - " + objPaymentModeDAO.getPaymentMode(payment.getPaymentmodes().getPaymentmodeid()) + "\n"
//                                + payment.getRemarks();
...
//
//                cal.set(Calendar.DATE, Integer.parseInt(transactionForm.getDate().split("/")[0]));
//                cal.set(Calendar.MONTH, Integer.parseInt(transactionForm.getDate().split("/")[1]) - 1);
//                cal.set(Calendar.YEAR, Integer.parseInt(transactionForm.getDate().split("/")[2]));
//                
//                Date date = cal.getTime();
//                payment.setPaiddate(date);
//                
//                Members members = new Members();
//                members.setMemberid(transactionForm.getMemberid());
//                payment.setMembers(members);
//                
...
//                    paymentmodeid = 2;
//                }
//                pm.setPaymentmodeid(paymentmodeid);
//                payment.setPaymentmodes(pm);
//                
...
//                        payment.setPaymentdetailses(paymentdetailsSet);
//                        direct = 1;
...
//                    }
//                    
//                    int paymentid = objPaymentDAO.savePayment(payment, flag, false);
//                    
//                    String member = transactionForm.getSelectedmember().split("-")[1];
//                    int memberno = Integer.parseInt(transactionForm.getSelectedmember().split("-")[0]);
//                    int paidamount = objPaymentDAO.getTotalAmount(members.getMemberid());
...
//                if (lstpayment.get(0).getPaymentmodes().getPaymentmodeid() == 1) {
//                    transactionForm.setPaymentmode("cash");
//                } else if (lstpayment.get(0).getPaymentmodes().getPaymentmodeid() == 2) {
...
//            int paymentid = objPaymentDAO.savePayment(payment, flag, true);
//            
//            String member = transactionForm.getSelectedmember().split("-")[1];
//            int memberno = Integer.parseInt(transactionForm.getSelectedmember().split("-")[0]);
//            int paidamount = objPaymentDAO.getTotalAmount(members.getMemberid());
...
//        transactionForm transactionForm = (transactionForm) form;
//        
//        String membername = transactionForm.getSelectedmember().split("-")[1];
//        String memberno = transactionForm.getSelectedmember().split("-")[0];
...
//        String paymentmode = payment.getPaymentmodes().getPaymentmodeid() == 1 ? "Cash" : "Cheque/NEFT";
//        
//        new PrintBill().printreceipt(membername, paidamount + "", Integer.parseInt(memberno), dateFormat.format(payment.getPaiddate()), payment.getPaidamount().intValue(), group.getGroupname(), paymentmode, payment.getPaymentid(), payment.getRemarks());
//        
//        return mapping.findForward("display");
//    }
//    
...
//            m.setMemberid(transactionForm.getMemberid());
//            
//            objsave.setMembers(m);
//            objsave.setAmount(transactionForm.getPrizeamount());
//            Drawtypes dr = new Drawtypes();
//            dr.setDrawtypeid(transactionForm.getDrawtypeid());
//            objsave.setDrawtypes(dr);
...
//                            table2.addCell(cell);
//                            
//                            para1 = new Paragraph(f1.getPaymentmodes().getPaymentmodeid() == 1 ? "Cash" : "Cheque/NEFT", font);
//                            para1.setAlignment(Element.ALIGN_CENTER);
//                            cell = new PdfPCell(para1);
//                            table2.addCell(cell);
//                            
